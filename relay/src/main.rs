    ...
    match args.command {
        ...
        Command::Upload { guest_binary } => {
            ...
            for guest_entry in guest_entries.into_iter() {
                ...
                let bonsai_client = get_client_from_parts(
                    args.global_opts.bonsai_api_url.clone(),
                    args.global_opts.bonsai_api_key.clone(),
                )
                .await?;
        ...
        Command::Run {
            ...
            let relayer = Relayer {
                ...
                bonsai_api_url: args.global_opts.bonsai_api_url,
                bonsai_api_key: args.global_opts.bonsai_api_key,
